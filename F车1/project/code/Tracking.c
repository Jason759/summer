...
int gyro_z,gyro_y;
int16 basespeed=140;    //110  //120  //140    //145基准速度
uint16 per=57; //前瞻  //58  //57   //57   //57
PID_t dir={         //方向PID
	  .kp=1.2,     //0.69  //0.82  //1.45  //1.2
	  .ki=0,
	  .kd=8.5,     	//1  //1   //2.5   //8.5
   	.kd2=0.003, //0.002  //0,002   //0.005  //0.003
	  .maxout=40,
	  .minout=-40,
	  .targ=93 
};
...
//	else if(center_line[per-30]<97&&center_line[per-30]>89&&(per-30)>hightest){
